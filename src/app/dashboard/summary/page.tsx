        ...
        <div className="p-6 space-y-6">
            <div className="flex justify-between items-center">
                ...
                >
                    ...
                    {loading ? "Menganalisis..." : "Generated Summary"}
                </button>
            </div>
            {response && (
                <div className="space-y-4">
                    ...
                    <div className="bg-white rounded-xl p-4 shadow">
                        <h3 className="text-lg font-semibold mb-2 text-yelow-600">📈 Analisi Tren</h3>
                    ...
                    <p className="text-xs text-gray-400">Powered by AI - Meta Lama 3.1 8B Instruct</p>
                </div>
            )}
