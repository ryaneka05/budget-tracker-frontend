...
export default function ProfilePage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setModal({ message: "Profile Berhasil Diperbarui", type:"success" });
    ...
    return (
        <div className="max-w-xl mx-auto p-6 space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    <label htmlFor="number" className="block mb-1 text-sm font-medium text-gray-700">Nomor Telpon</label>
                ...
                >
                    {isSubmitting ? "Menyimpan..." : "Simnpan Perubahan"}
                </button>
            </form>
