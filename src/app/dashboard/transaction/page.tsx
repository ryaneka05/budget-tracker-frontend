...
import { fetchTransaction, fetchTotalExpenseStat, deleteTransaction } from "@/services/transaction";
    ...
    return (
        <div className="p-4 space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <TransactionCard title="Total Pengeluaran Hari Ini" 
                value={formatRupiah(stats.total_expense)}/>
                <TransactionCard title="Jumlah Transaksi Hari Ini" 
                value={formatRupiah(stats.count)}/>
            </div>
                        ...
                        <tbody>
                            {transaction.length > 0 ? (
                                transaction.map((tx, idx) => {
                                    ...
                                    return (
                                        <tr key={tx.id} className="border-t text-gray-700">
