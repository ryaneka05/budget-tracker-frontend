            ...
            try{
                ...
                if (isLogin) {
                    ...
                    if (!termsCheckboxRef.current?.checked) {
                        setErrors({ terms: "Kamu harus mensetujui Terms & Pricvacy" });
                        return;
                    }
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4 py-12">
            <div className="grid grid-cols-1 md:grid-cols-2 w-full max-w-7xl bg-white shadow-2xl rounded-2xl overflow-hidden">
                ...
                <div className="p-8 sm:p-12 min-h-[750px] flex flex-col justify-center">
                    {/* Ini bagian title dan subtitle auth */}
                    ...
                    {/* form input untuk register / logn */}
                    <form onSubmit={handleSubmit} className="space-y-4">
                        {/* ini akan muncul ketika dia kondisinya adalah register */}
                        {!isLogin && (
                        ...
                        {/* ini muncul ketika dia kondisinya itu login / register */}    
                        <div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <button
                                    type="button"
                                    className="absolute right-3 top-1/2 transform -translate-1/2 text-gray-500"
                            ...
                            <div className="flex items-center">
                                ...
                                <label htmlFor="terms" className="ml-2 block text-sm text-gray-700">
                                    ...
                                    <button type="button" className="text-indigo-600 hover:underline"
                                        onClick={() => (setShowModal(!showModal))}>Term & Privacy Policy
                                    </button>
                                </label>
                            </div>
                        )}
