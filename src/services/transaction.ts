...
export const fetchTransactionById = async (id: number) => {
    try {
        ...
        handleApiError(error, "Failed to fetch Transaction By Id")
    }
}
...
export const editTransaction = async (id: number, data: Record<string, unknown>) => {
    try {
        ...
        handleApiError(error, "Failed to edit Transaction")
    }
}
...
export const fetchMonthlyChart = async () => {
    try {
        ...
        handleApiError(error, "Failed to fetch Monthly Chart")
    }
}
